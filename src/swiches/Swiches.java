...
public class Swiches {
    ...
    public void coloresPrimarios() {
        ...
        switch (color) {
            ...
            case "verde":
            case "azul":
                JOptionPane.showMessageDialog(null, "Es un color primario.");
                break;
    ...
    public void cajeroAutomatico() {
        ...
        switch (op) {
            case 1: JOptionPane.showMessageDialog(null, "Su saldo es: $" + saldo); break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4: JOptionPane.showMessageDialog(null, "Gracias por usar el cajero."); break;
